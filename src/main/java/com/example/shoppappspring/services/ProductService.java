...
import com.example.shoppappspring.exceptions.InvalidParamException;
...
import com.example.shoppappspring.repositories.CategoryRepository;
import com.example.shoppappspring.repositories.ProductImageRepository;
import com.example.shoppappspring.repositories.ProductRepository;
...
public class ProductService implements IProductService{
    ...
    public ProductImage createProductImage(
        ...
        Product existingProduct = productRepository
                .findById(productId)
                .orElseThrow(() -> new DataNotFoundException(
                        "Cannot dind product with id: " + productImageDTO.getProductId()));
